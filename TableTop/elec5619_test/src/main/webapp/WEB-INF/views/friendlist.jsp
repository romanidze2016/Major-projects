...
<body>
    ...
    <div id="content">
    	<ul class="tabs">
    		...
    		<li class="selected"><a class="selectedLink" href="friendlist">Friend List</a></li>
    		<li class="unselected"><a class="unselectedLink" href="friendrequests">Friend Requests</a></li>
    	</ul>
    	
	    <h2>Friend list</h2>
		
		<form class="friendRequest" action="removeFriend" method="post">
			<table class="resultTable">
				...
				<c:forEach items="${listOfUsers}" var="user">
	    			<tr class="resultTr">
	      			...
	      			<td><button class="myButton" id="smallButton" name="friend" value="${user.username}">Remove</button></td>
	    			</tr>
	    		</c:forEach>
			</table>
		</form>
